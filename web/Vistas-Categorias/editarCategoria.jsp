...
<html>
    ...
    <body background="assets/imgs/2.jpg" class="m-0 row justify-content-center">
    ...
    <center>
        ...
        <div class="card text-center" style="width: 18rem;">
            <div class="card-body">
                ...
                <td align="right"> Nombre:<input type="text" value='<%= nombre_cat%>' name="nombre" id="nombre" class="form-control" placeholder="Nombre Categoria" required="true"> </td>                

                <td align="right"> Estado: <input type="text" value='<%= estado_cat%>' name="estado" id="estado" class="form-control" placeholder="Estado Categoria" required="true"></td>              
