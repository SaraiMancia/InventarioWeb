...
public class categoriasS extends HttpServlet {
       ...
       //this.listaCategorias(request, response);
         ...
         */
         ...
         if(estado.equals("listar")){
             ...
             RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/Vistas-Categorias/editarCategoria.jsp?id="+id_cat+"&&nombre="+nombre_cat+"&&estado="+estado_cat);
             dispatcher.forward(request, response);
